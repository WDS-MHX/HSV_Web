...
export default function hethongvanban() {
  ...
  return (
    <div className='flex flex-col w-full md:justify-center md:items-center lg:items-start my-4'>
      <div className='flex lg:flex-row flex-col items-center lg:justify-between w-full mb-4'>
        <div
          className={`flex md:flex-row flex-col items-center justify-between gap-[24px] lg:w-[44.5rem] md:w-[39.375rem] lg:px-8 px-[16px] w-full px-8 py-[0.625rem] ${isAdmin ? 'md:bg-slate-100' : 'lg:bg-slate-100'} rounded-md`}
        >
          <Filter
