    ...
    <Listbox value={selected} onChange={setSelected}>
      ...
      >
        {options.map((option) => (
          ...
          >
            <FaChevronDown className='invisible size-4 font-normal fill-slate-700 group-data-[selected]:visible' />
            <div className='text-sm text-slate-700'>{option.optionName}</div>
          </ListboxOption>
        ))}
      </ListboxOptions>
    </Listbox>
